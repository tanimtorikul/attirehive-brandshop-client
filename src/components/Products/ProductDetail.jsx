          ...
          <div className="w-full px-4 md:w-1/2 ">
            <div className="lg:pl-20">
              <div className="mb-8 ">
                ...
                <h2 className="max-w-xl mt-2 mb-6 text-2xl font-extrabold text-black  md:text-4xl">
                  {name}
                </h2>
              ...
              <div className="flex items-center mb-8">
                ...
                <div className="flex flex-wrap -mx-2 -mb-2">
                  <button className="p-1 mb-2 mr-2 border border-transparent hover:border-blue-400 border-gray-800 ">
                    <div className="w-6 h-6 bg-cyan-300"></div>
                  </button>
                  <button className="p-1 mb-2 mr-2 border border-transparent hover:border-blue-400 border-gray-800">
                    <div className="w-6 h-6 bg-green-300 "></div>
                  </button>
                  <button className="p-1 mb-2 border border-transparent hover:border-blue-400 border-gray-800">
                    <div className="w-6 h-6 bg-red-200 "></div>
                  </button>
                </div>
              </div>
              <div className="flex items-center mb-8">
                <h2 className="w-16 text-xl font-bold text-gray-400">Size:</h2>
                <div className="flex flex-wrap -mx-2 -mb-2">
              ...
              <div className="w-32 mb-8 ">
                <label className="w-full text-xl font-semibold text-gray-700">
                  Quantity
                </label>
                <div className="relative flex flex-row w-full h-10 mt-4 bg-transparent rounded-lg">
                  ...
                  <input
                    type="number"
                    className="flex items-center w-full font-semibold text-center  outline-none text-gray-400  focus:outline-none text-md "
                    placeholder="1"
                  />
              ...
              <div className="flex justify-center items-center -mx-4 ">
                <div className="w-full px-4 mb-4 lg:w-1/2 lg:mb-0">
                  <button
                    ...
                    className="flex items-center justify-center w-full p-4  border rounded-md text-gray-200 text-xl bg-black "
                  >
                    Add to Cart
                  </button>
                </div>
